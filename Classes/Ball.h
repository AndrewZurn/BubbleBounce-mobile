...
public:
    ...
    int getState() {
        return _state; }
    const char* getBallColor() {
        return _ballColor; }
    std::vector<Ball*> getCollisionArray() {
    ...
    const char* getSelectedBallImage() {
        return _ballSelected; }
    const char* getOriginalBallImage() {
        return _ball; }
    int getBallId() {
        return _ballId; }
    int getTopScreenAdjust() {
        return _topScreenAdjust; }
    bool getCanCollide() {
        return _canCollide; }
    ...
    void setBallColor(const char* ballColor) {
        _ballColor = ballColor; }
    void setBall(const char* ball)
    {
        _ball = ball;
    };
    void setBallSelected(const char* ballSelected) {
        _ballSelected = ballSelected; }
    void setRadius(int radius) {
        _radius = radius; }
    void setState(int state) {
        _state = state; }
    void setCollisionArray(std::vector<Ball*> collisionArray) {
        _collisionArray = collisionArray; }
    void setBallId(int ballId) {
        _ballId = ballId; }
    void setTopScreenAdjust(int topScreenAdjust) {
        _topScreenAdjust = topScreenAdjust; }
